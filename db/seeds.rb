...
Game.find_or_create_by(order_id: 100, fid:"angry_finches", title: "Angry Finches", offsetX:"-40px", offsetY:"20px", width:'1024px', height:'772px', text: "", url: "/angry_finches/index.html")
