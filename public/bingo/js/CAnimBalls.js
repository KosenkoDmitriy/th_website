function CAnimBalls(iX, iY,iNumBall,oParentContainer){
    ...
    this._init = function(iX, iY,iNumBall){
        ...
        for(var i=0; i<7; i++){
            ...
            _aBall[i] = new CBallExtracted(0,iBallY,oSprite.width/NUM_DIFFERENT_BALLS, oSprite.height,iRandomColor,32,_oSpriteSheetBall,_oContainerBallInTube);
        ...
        var oBallPreview = new CBallExtracted(50 - (_iWidthPreviewBall/2),122 + oSprite.height/2,_iWidthPreviewBall, oSprite.height,_aBall[0].getColor(),80,
        ...
        var graphics = new createjs.Graphics().beginFill("rgba(255,0,0,0.01)").drawCircle(oBgNumber.x + oSprite.width/2,oBgNumber.y + oSprite.height/2,92)
    ...
    this.placeNewBall = function(){
        ...
        if(_iCounter === _aBall.length){
            ...
            var oBall = new CBallExtracted(0,_aBall[_aBall.length-1].getY() - oSprite.height,oSprite.width/NUM_DIFFERENT_BALLS, oSprite.height,iRandomColor,
                                                                                                                                    32,_oSpriteSheetBall,_oContainerBallInTube);
    ...
    this.placeNewPreviewBall = function(){
        ...
        if(_iCounterPreview === _aBallPreview.length){
            ...
            var oBall = new CBallExtracted(50 - (_iWidthPreviewBall/2),122 + oSprite.height/2,oSprite.width/NUM_DIFFERENT_BALLS, oSprite.height,
                                                                                        _aBall[_iFirstBallOutOfTube].getColor(),80,_oSpriteSheetBallPreview,_oContainerPreview);
