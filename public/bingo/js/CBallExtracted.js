function CBallExtracted(iXPos,iYPos,iWidth,iHeight,iColor,iFontSize,oSpriteSheet,oParentContainer){
    var _iColor;
    var _oBall;
    var _oTextBack;
    var _oText;
    ...
    this._init = function(iXPos,iYPos,iWidth,iHeight,iColor,iFontSize,oSpriteSheet){
        _iColor = iColor;
        ...
        _oTextBack = new createjs.Text("",iFontSize+"px " +PRIMARY_FONT, "#000");
        ...
        _oText = new createjs.Text("",iFontSize+"px " +PRIMARY_FONT, BALL_COLORS[iColor]);
    ...
    this._init(iXPos,iYPos,iWidth,iHeight,iColor,iFontSize,oSpriteSheet);
}