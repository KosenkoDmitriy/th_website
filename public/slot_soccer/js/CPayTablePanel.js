function CPayTablePanel(){
    ...
    this._init = function(){
        ...
        for(i=0;i<3;i++){
            var oText = new createjs.Text("X"+(5-i),"26px "+FONT_GAME, "#ffffff");
        ...
        for(i=0;i<3;i++){
            var oText = new createjs.Text(s_aSymbolWin[0][4-i],"26px "+FONT_GAME, "#ffff00");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        for(i=0;i<3;i++){
            var oText = new createjs.Text(s_aSymbolWin[1][4-i],"26px "+FONT_GAME, "#ffff00");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        for(i=0;i<4;i++){
            var oText = new createjs.Text(s_aSymbolWin[2][4-i],"21px "+FONT_GAME, "#ffff00");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
