function CHelpPanel(){
    ...
    this._init = function(){
        ...
        var oText2Pos = {x: CANVAS_WIDTH/2 -180, y: (CANVAS_HEIGHT/2)-50}
        ...
        var oText3Pos = {x: CANVAS_WIDTH/2, y: (CANVAS_HEIGHT/2) +90}
        ...
        _oTextWinPage2Back = new createjs.Text(TEXT_HELP2_PAGE2 + "+" +POINTS_TO_WIN + TEXT_WIN_PAGE2," 28px "+PRIMARY_FONT, "#000000");
        _oTextWinPage2Back.x = CANVAS_WIDTH/2 -328;
        _oTextWinPage2Back.y = (CANVAS_HEIGHT/2) -88;
        _oTextWinPage2Back.textAlign = "left";
        _oTextWinPage2Back.lineWidth = 670;

        _oTextWinPage2 = new createjs.Text(TEXT_HELP2_PAGE2 + "+" +POINTS_TO_WIN + TEXT_WIN_PAGE2," 28px "+PRIMARY_FONT, "#ffffff");
        _oTextWinPage2.x = CANVAS_WIDTH/2 -330;
        _oTextWinPage2.y = (CANVAS_HEIGHT/2) -90;
        ...
        _oGroupPage2.addChild(_oHelpBgPage2, _oText1BackPage2,  _oText1Page2, 
                            _oTextWinPage2Back, _oTextWinPage2, _oTextLosePage2Back, _oTextLosePage2);//Add more bitmap here
